export const enMessages = {
  ...
  "settings.fontSize.description": "Adjust text size across the app",
  ...
  "feeds.action.check": "Check feed",
  "feeds.action.refresh": "Refresh feed",
  ...
  "feeds.toast.refreshingOne": "Refreshing {name}...",
  "feeds.toast.refreshOneFailed": "Failed to refresh {name}",
  "feeds.toast.checkSuccess": "{name} is healthy (HTTP {status}, {count} items)",
  "feeds.toast.checkFailed": "Failed to check {name}: {error}",
