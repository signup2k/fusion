export const zhMessages = {
  ...
  "settings.fontSize.description": "调整应用内的文字大小",
  ...
  "feeds.action.check": "检测订阅源",
  "feeds.action.refresh": "刷新订阅源",
  "feeds.batchDelete.clearVisible": "取消全选",
  "feeds.batchDelete.deleteSelected": "删除所选（{count}）",
  "feeds.batchDelete.description":
    "确定要删除所选的 {count} 个订阅吗？这些订阅下的所有文章也会被删除。",
  "feeds.batchDelete.failed": "批量删除订阅失败，请检查后重试",
  "feeds.batchDelete.selectFeed": "选择订阅“{name}”",
  "feeds.batchDelete.selectVisible": "全选当前结果",
  "feeds.batchDelete.start": "批量删除",
  "feeds.batchDelete.success": "已删除 {count} 个订阅",
  "feeds.batchDelete.title": "批量删除订阅",
  ...
  "feeds.toast.refreshingOne": "正在刷新“{name}”...",
  "feeds.toast.refreshOneFailed": "刷新“{name}”失败",
  "feeds.toast.checkSuccess": "“{name}”检测正常（HTTP {status}，{count} 个条目）",
  "feeds.toast.checkFailed": "“{name}”检测失败：{error}",
